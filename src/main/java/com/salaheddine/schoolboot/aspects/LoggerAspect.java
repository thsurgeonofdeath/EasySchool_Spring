package com.salaheddine.schoolboot.aspects;
...
public class LoggerAspect {
    @Around("execution(* com.salaheddine.schoolboot..*.*(..))")
    ...
    @AfterThrowing(value = "execution(* com.salaheddine.schoolboot.*.*(..))",throwing = "ex")
